    ...
    <>
      <BrowserRouter>
        <NavBar />   
          {token ? (
            <Routes>
              <Route path="/complete_profile" element={userAuth?.isComplete ? <Navigate to="/edit"/> : <CompleteProfile />} />
              ...
              <Route path="/assigned_task" element={userAuth.role==="user" ? <UserAssignedTask/> : <Navigate to="/users"/>}/>
              <Route path="/accepted_task" element={userAuth.role==="user" ? <UserAcceptedTask/> : <Navigate to="/users"/>}/>
              <Route path="/approved_task" element={userAuth.role==="user" ? < UserApprovedTasks/> : <Navigate to="/users"/>}/>
